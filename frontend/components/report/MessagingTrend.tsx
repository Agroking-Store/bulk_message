...
export default function MessagingTrend({ days }: MessagingTrendProps) {
  ...
  return (
    <div id="messaging-trend-chart" className="border border-gray-100 rounded-2xl bg-white p-5 shadow-sm h-[300px] flex flex-col">
      <div className="flex justify-between items-start mb-4">
        <div>
          <h2 className="font-bold text-xl text-gray-800">Whatsapp Campaign Performance</h2>
      ...
      <div className="flex-1 w-full -ml-6 relative">
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              <defs>
                <linearGradient id="colorSentWa" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#3b82f6" stopOpacity={0.1} />
                  <stop offset="95%" stopColor="#3b82f6" stopOpacity={0} />
                </linearGradient>
                <linearGradient id="colorFailedWa" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area type="monotone" name="Sent" dataKey="sent" stroke="#3b82f6" strokeWidth={2} fill="url(#colorSentWa)" />
              <Area type="monotone" name="Failed" dataKey="failed" stroke="#ef4444" strokeWidth={2} fill="url(#colorFailedWa)" />
            </AreaChart>
          </ResponsiveContainer>
        )}
      </div>
